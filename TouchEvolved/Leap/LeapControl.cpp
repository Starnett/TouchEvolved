...
void LeapListener::handleCircleGesture(Gesture gesture) {
...
void LeapListener::handleSwipeGesture(Gesture gesture) {
...
void LeapListener::handleKeyTapGesture(Gesture gesture) {
...
void LeapListener::handleScreenTapGesture(Gesture gesture) {
