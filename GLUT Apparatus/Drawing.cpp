...
//since they were only declared in the drawing.h must now make space for them
int prism_index, prism_index2, prism_index3; 
GLfloat prism_height;
GLfloat full_rotation;
int surround_light;
GLfloat ambient_red, ambient_green, ambient_blue, diffuse_red, diffuse_green, diffuse_blue, specular_red, specular_green, specular_blue, shine;
GLfloat mat[4];
GLfloat mat2[4];
GLfloat mat3[4];
int triforce_color;
...
void draw_cone_tri_calc(double height, double radius, int base_tri) 
{
	...
	{		
		...
		glColor3f(0.0f, 0.0f, 1.0f );
		glVertex3f(0.0f, cone_point, 0.0f);
